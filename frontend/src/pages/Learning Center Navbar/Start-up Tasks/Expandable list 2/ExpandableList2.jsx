        ...
        <div className="mainsteps-container">
            ...
            <div className='steps-container'>
                <ol>
                    ...
                    Appoint a Registered Agent. Businesses must maintain an address for service of process where legal documents can be received. Ascend provides Registered Agent service for all companies that we form. This is an important, often overlooked, task on a business startup checklist.
                    </li>
                    <li className="step-item">
                    ...
                    <li className="step-item">
                    Complete additional filings as needed. Companies that expand to do business outside their original state of incorporation or LLC formation generally register in those additional states. Ascend can assist with these registration filings, also called "qualifications." Amendments can also be filed if the information listed on the formation document, like the legal name of the company or address, changes.
                    </li>
                    ...
                    {isExpanded && (
                        <>
                            ...
                            <li className="step-item">Draft internal documents for the business. Corporations are governed by their internal bylaws, whereas LLCs are governed by an operating agreement. Ascend can customize bylaws or an LLC operating agreement for your business. This is a step on your new business checklist that helps with organization.</li>
                            <li className="step-item">Establish a business presence. Identify a location for the business and establish a business address. Ascend offers regular mail forwarding service in either Delaware or Nevada.</li>
                            <li className="step-item">Get a business credit card. A business credit card helps separate your professional and personal expenses and can help you protect your personal assets from business liabilities. Ascend highly recommends this step to starting a business.</li>
